"""Test the 123\\SmartBMS implementation."""
...
class Mock123SmartBleakClient(MockBleakClient):
    """Emulate a 123\\SmartBMS gen3 BleakClient (Nordic UART, ping-driven stream)."""
...
async def test_update(patch_bleak_client, keep_alive_fixture: bool) -> None:
    """Test 123\\SmartBMS data update."""
    patch_bleak_client(Mock123SmartBleakClient)

    bms = BMS(generate_ble_device(), keep_alive_fixture, secret="8182")
